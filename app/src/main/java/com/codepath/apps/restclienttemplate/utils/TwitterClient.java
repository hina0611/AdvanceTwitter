...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "HEIOrRntArLcR4KsTvUQS4uuW";       // Change this
	public static final String REST_CONSUMER_SECRET = "mEVY0nKCnI9YJFPGUkY6BGT5dzzsbM4JY7lgwlDX8rnaKsRJ94"; // Change this
	public static final String REST_CALLBACK_URL = "https://codepath.github.io/android-rest-client-template/success.html"; // Change this (here and in manifest)
